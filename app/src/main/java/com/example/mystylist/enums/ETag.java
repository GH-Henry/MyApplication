...
public enum ETag {
    ...
    public static boolean matches(long mask1, long mask2) {
        return mask1 == mask2;
    }
    public static boolean satisfies(long mask1, long mask2) {
        return (mask1 & mask2) == mask2;
    }
    public static boolean anyMatch(long mask1, long mask2) {
